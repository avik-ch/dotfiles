...
[[ ! -r '/Users/avik/.opam/opam-init/init.zsh' ]] || source '/Users/avik/.opam/opam-init/init.zsh' > /dev/null 2> /dev/null
...
__conda_setup="$('/Users/avik/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/avik/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/avik/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/avik/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
